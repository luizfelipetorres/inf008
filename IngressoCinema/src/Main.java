import negocio.Sala;
import negocio.SalaGrande;

/**
 * Construa um sistema orientado a objetos, utilizando programação em três níveis, que
 * atenda a venda de bilhetes de cinema.
 * Neste cinema existem 3 salas grandes, 4 médias e 5  pequenas, cada uma com respectivamente
 * 500, 300 e 100 lugares.
 * Cada sala tem uma identificação que corresponde as 10 sessões durante o dia,
 * que começam uma hora da tarde e acabam dez horas da noite.
 * Bilhetes vendidos para salas grandes independente do
